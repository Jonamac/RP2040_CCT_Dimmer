...
- DUMB duty endpoint snap zones: `dumbDutyFiltered < 0.03` → clamp to 0; `dumbDutyFiltered > 0.97` → clamp to 1. Ensures pots that don't reach full ADC range can still hit 0% and 100%.
